 ...
 *
 * NOTE: This file is a duplicate of the top-level Code.gs kept only for
 * repo documentation purposes. An actual Apps Script project has ONE
 * Code.gs — don't paste both files into the Apps Script editor as separate
 * scripts, that would double-declare every function. Use whichever single
 * copy you paste into script.google.com and delete the other from git.
 *
